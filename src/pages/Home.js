    ...
    <div className='Home-container'>
      <div className='Home-navbar-container'>
        <div className='Home-navbar-buttons-container'>
          { (homeSection !== 0) && <button onClick={() => setHomeSection(0)}>Start</button> }
          { (homeSection !== 1) && <button onClick={() => setHomeSection(1)}>Login</button> }
          { (homeSection !== 2) && <button onClick={() => setHomeSection(2)}>About</button> }
        </div>
      </div>
